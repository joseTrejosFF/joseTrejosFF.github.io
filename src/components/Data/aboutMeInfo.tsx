export const aboutMeInfo = {
  ...
  body: [
    ...
    "Since then I have been working on IT Operations (Ops) and it's been a wonderful journey. A few years ago while attending my first computer programming lecture at the university, I learned some basic coding stuff.",
    ...
    "One day, while looking for how to code on google (literally) I found an article titled 'tips to learn programming'. The author recommended something so basic and so overlooked by myself, it was \"Learn By Doing\" and that was it. The key to truly understanding the concepts of programming is by coding not just reading.",
